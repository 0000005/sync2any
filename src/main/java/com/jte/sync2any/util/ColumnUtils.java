...
public final class ColumnUtils {
     ...
     * @return
     */
    public static List<String> delEscape(List<String> cols) {
        // sql standard
     ...
     * @return
     */
    public static String delEscape(String colName) {
     ...
     * @return
     */
    public static List<String> addEscape(List<String> cols) {
        if (CollectionUtils.isEmpty(cols)) {
            return cols;
        }
        List<String> newCols = new ArrayList<>(cols.size());
     ...
     */
    public static String addEscape(String colName) {
        if (isMysqlSeries()) {
            return addEscape(colName, Escape.MYSQL);
        }
        return addEscape(colName, Escape.STANDARD);
    }
     ...
     * @return
     */
    private static String addEscape(String colName, Escape escape) {
        if (colName == null || colName.isEmpty()) {
            return colName;
        }
        if (colName.charAt(0) == escape.value && colName.charAt(colName.length() - 1) == escape.value) {
        ...
        KeywordChecker keywordChecker = new MySQLKeywordChecker();
    ...
    private static boolean isMysqlSeries() {
        return true;
    }
