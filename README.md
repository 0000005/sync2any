...
## 为什么开发这个项目？
我们使用了腾讯云的TDSQL,但是腾讯云唯一提供可用的数据导出只有CKAFKA这一个渠道。于是如果我们想将数据导入到ES或者其他数据源，必须得自己开发中间件，别无他法。
...
- 一旦同步过程中发生任何错误，该任务会停止继续同步，防止数据错乱。其他正常的任务可继续执行，不影响。建议排除故障后，重启sync2es继续同步。
...
### 腾讯云目前的问题
问题我都提工单反馈了，回复说2020年6月解决。大家可以都提一下工单，加快解决速度，如问题已经解决，请提issue反馈。
